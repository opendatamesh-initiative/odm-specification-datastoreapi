...
<a name="schemaDatabaseSchemaName"></a>databaseSchemaName | `string` | The name of the *schema* that collects the tables exposed by this Datastore API. This field is used only for [Database Management System](#database-management-system) that groups tables within a [Database](#database) in schemas. 
